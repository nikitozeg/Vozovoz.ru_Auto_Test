...
public class QACalculatorTest {
    ...
    public void login() throws InterruptedException {
        ...
        for (int second = 0; ; second++) {
            if (second >= 10) {
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\login FAIL " + System.currentTimeMillis() + ".png", "");
                break;
            }
            try {
        ...
        for (int second = 0; ; second++) {
            if (second >= 10) {
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\Мои Данные find is FAIL " + System.currentTimeMillis() + ".png", "");
                break;
            }
            try {
    ...
    public void waitLoad() throws InterruptedException {
        for (int second = 0; ; second++) {
            if (second >= 10) {
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\Не прогрузилось слово Перевозка " + System.currentTimeMillis() + ".png", "");
                //fail("timeout");
                break;
            }
            try {
    ...
    public void assertSetCheckOut(String l, String w, String h, String weight, String amount, int cost) throws InterruptedException {
        try {
            ...
            selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\unit filling is fail " + cost  + " "+ System.currentTimeMillis() + ".png", "");
        }

        for (int second = 0; ; second++) {
            if (second >= 4) {
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\Правильная цена " + cost + " "+ System.currentTimeMillis() + ".png", "");
                break;
            }
            try {
                ...
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\Три точки в цене "+ System.currentTimeMillis() + ".png", "");
            }
            Thread.sleep(1000);
        }
    ...
    public void checkOut() throws InterruptedException {
        ...
        try {
            ...
            selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\click on orderCreate is fail " + " "+ System.currentTimeMillis() + ".png", "");
            ...
            try{   selenium.click("xpath=(//*[@test-id='order.backward'])");
                ...
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\click on orderBACKWARD is fail " + " "+ System.currentTimeMillis() + ".png", "");
    ...
    public void testVar9SpbMsk() throws Exception {
        ...
        while (true) {
            ...
            try{   selenium.open("/");
                ...
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\FAIL OCCURED "+System.currentTimeMillis()+".png", "");
            ...
            try {
                ...
                selenium.captureEntirePageScreenshot("C:\\QAerrorlog\\Cities checking is FAIL "+System.currentTimeMillis()+".png", "");
